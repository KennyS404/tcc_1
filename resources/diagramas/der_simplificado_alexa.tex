...
\tikzset{
  entity/.style={rectangle, draw, fill=blue!20, text width=2.5cm, text centered, minimum height=1.2cm},
  attribute/.style={ellipse, draw, fill=yellow!20, text width=1.8cm, text centered, minimum height=0.6cm},
  relationship/.style={diamond, draw, fill=green!20, text width=1.5cm, text centered, minimum height=0.8cm}
}
